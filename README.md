...
The file ParkerEqFinal is the final version of my code which includes the full RK4 method which solves for the velocity profile. The density profile is calculated from the velocity and analytical approximations are applied to check the solution aligns with the theory it is derived from.
